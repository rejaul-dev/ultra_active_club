...
const Questions = () => {
  return (
    <div>
      <div>
        <h1 className="text-xl font-bold text-center">Questions about React</h1>
      </div>
      <div
        tabIndex={0}
      ...
      >
        ...
        <div className="collapse-content">
          <p>
            The useEffect Hook let us perform side effects in function
            components. By using this Hook, you tell React that your component
            needs to do something after render. React will remember the function
            you passed (we’ll refer to it as our “effect”), and call it later
